...
async def save_analysis(job_id: str, phash: str, similar_users: list[str],
    ...
    try:
        await conn.execute("""
            INSERT INTO "Analysis" ("id", "jobId", "pHash", "similarUsers", "burstDetected", "harmScore", "clipSimilarity", "verdict", "reasons", "analyzedAt")
            VALUES (gen_random_uuid(), $1, $2, $3, $4, $5, $6, $7, $8, NOW())
        """, job_id, phash, similar_users, burst_detected, harm_score, clip_similarity, verdict, reasons)
